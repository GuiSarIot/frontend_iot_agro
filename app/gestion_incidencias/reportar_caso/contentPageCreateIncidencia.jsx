...
const ContentPageCreateIncidencia = ({
    infoPage = {
        title: 'Crear Incidencia',
        route: 'gestion_incidencias/crear'
    }
}) => {
    ...
    const validateForm = () => {
        const { tipoDocumento, numeroDocumento, rolInstitucional, rolesUsuario, profilePicture } = inputsValues
    ...
    return (
        <>
            <MainForm submitText="Guardar" inputsValues={inputsValues} url={`${process.env.NEXT_PUBLIC_API_URL}/gestion_usuarios/crear`} method="POST" onSuccesResponse={userCreated} onErrorResponse={userNotCreated} onValidate={validateForm}>
                <section>
                    ...
                    <div className={stylesMainForm.sectionInputs}>
                        <InputForm label="Tipo de documento*" type="select" name="tipoDocumento" specialConf={{
                            options: listTypeDocuments.map(({ code, name }) => ({ name, code })),
                            valueState: inputsValues,
                            setValueState: setInputsValues
                        }} />
                        <InputForm label="Número de documento*" required={true} type="number" name="numeroDocumento" specialConf={{
                            min: 0,
                            max: 9999999999,
                            valueState: inputsValues,
                            setValueState: setInputsValues
                        }} />
                        <InputForm label="Nombres*" required={true} type="text" name="nombres" specialConf={{
                            valueState: inputsValues,
                            setValueState: setInputsValues
                        }} />
                        <InputForm label="Apellidos*" required={true} type="text" name="apellidos" specialConf={{
                            valueState: inputsValues,
                            setValueState: setInputsValues
                        }} />
                        <InputForm label="Número de teléfono" type="text" name="numeroTelefono" specialConf={{
                            valueState: inputsValues,
                            setValueState: setInputsValues
                        }} />
                        <InputForm label="Correo electrónico personal" type="email" name="correoElectronico" specialConf={{
                            valueState: inputsValues,
                            setValueState: setInputsValues
                        }} />
                ...
                <section>
                    ...
                    <div className={stylesMainForm.sectionInputs}>
                        <InputForm label="Correo electrónico corporativo*" required={true} type="email" name="correoElectronicoCorporativo" specialConf={{
                            valueState: inputsValues,
                            setValueState: setInputsValues
                        }} />
                        <InputForm label="Skype" type="text" name="skype" specialConf={{
                            valueState: inputsValues,
                            setValueState: setInputsValues
                        }} />
                        <InputForm label="Estado*" required={true} type="select" name="estado" specialConf={{
                            options: [
                        ...
                        <InputForm label="Origen" type="text" name="origen" specialConf={{
                            valueState: inputsValues,
                            setValueState: setInputsValues
                        }} />
                        <InputForm label="Última integración" type="date" name="ultimaIntegracion" specialConf={{
                            valueState: inputsValues,
                            setValueState: setInputsValues
                        }} />
                        <InputForm label="Tipo vinculación*" required={true} type="select" name="tipoVinculacion" specialConf={{
                            options: [
                        ...
                        <InputForm label="Profesión" type="text" name="profesion" specialConf={{
                            valueState: inputsValues,
                            setValueState: setInputsValues
                        }} />
                        <InputForm label="Fecha inicio contrato" type="date" name="fechaInicioContrato" specialConf={{
                            valueState: inputsValues,
                            setValueState: setInputsValues
                        }} />
                        <InputForm label="Fecha fin contrato" type="date" name="fechaFinContrato" specialConf={{
                            valueState: inputsValues,
                            setValueState: setInputsValues
                        }} />
                        <InputForm label="Regional*" required={true} type="select" name="regional" specialConf={{
                            options: listRegions.map(({ code, name }) => ({ code, name })),
                            valueState: inputsValues,
                            setValueState: setInputsValues,
                            onChange: loadCenters
                        }} />
                        <InputForm label="Centro*" required={true} type="select" name="centro" specialConf={{
                ...
                <section>
                    <div className={stylesMainForm.sectionTitle}>
                        ...
                        <p className={stylesPage.sectionTitleP}>Se debe asignar un rol de usuario o un rol institucional al usuario</p>
                    </div>
                    <div className={stylesMainForm.sectionInputs}>
                        <InputForm label="Roles del usuario" type="multiselect" name="rolesUsuario" specialConf={{
                            options: listRols.map(({ code, name }) => ({ name, code })),
                            valueState: inputsValues,
                            setValueState: setInputsValues
                        }} />

                        <InputForm label="Rol institucional" type="select" name="rolInstitucional" specialConf={{
                ...
                <section>
                    ...
                    <div className={stylesMainForm.sectionInputs}>
                        <InputForm label="Nombre de usuario*" required={true} type="text" name="nombreUsuario" specialConf={{
                            valueState: inputsValues,
                            setValueState: setInputsValues
                        }} />
                        <InputForm label="Contraseña*" required={true} type="password" name="password" specialConf={{
                            valueState: inputsValues,
                            setValueState: setInputsValues
                        }} />
                        <InputForm label="Confirmar contraseña*" required={true} type="password" name="passwordConfirm" specialConf={{
                            valueState: inputsValues,
                            setValueState: setInputsValues
                        }} />
                    </div>
...
ContentPageCreateIncidencia.propTypes = {
...
export default ContentPageCreateIncidencia