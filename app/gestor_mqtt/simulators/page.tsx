...
export default function MqttSimulatorsPage() {
    ...
    return (
        <div className={styles.container}>
            ...
            <div className={styles.header}>
                <div className={styles.headerContent}>
                    <div className={styles.headerTitle}>
                        ...
                        <p>Prueba de comandos en tiempo real para dispositivos IoT</p>
                    </div>
                    <div className={styles.headerActions}>
                        <button onClick={loadDevices} className={styles.iconButton} title="Actualizar">
                            <RefreshIcon />
                        </button>
                        <button 
                            onClick={() => setShowFullPanel(!showFullPanel)} 
                            className={styles.iconButton}
                            title={showFullPanel ? 'Vista compacta' : 'Vista completa'}
                        >
                            {showFullPanel ? <PhoneAndroidIcon /> : <DashboardIcon />}
                        </button>
                    </div>
                </div>
            </div>
            ...
            <div className={styles.deviceSelectorBar}>
                <label className={styles.deviceSelectorLabel}>Dispositivo:</label>
                <Dropdown
