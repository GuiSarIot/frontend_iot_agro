...
const ContentPage = ({
    infoPage ={
        title: 'Aprendices - Etapa productiva',   
        route: '/reportes_sofia/aprendices/etapa_productiva',       
    }
}) => {
    ...
    const onSuccesForm = (message, data) => {
        const stateCsv = GenerateCSV({
            data,
            fileName: 'reporte_aprendices_etapa_productiva',
            textSuccess: 'Reporte de aprendices generado',
    ...
    return (
        <>
            <MainForm submitText="Generar reporte" inputsValues={inputsValues} url={`${process.env.NEXT_PUBLIC_API_URL}/reportes_sofia/aprendices/etapa_productiva`} method="POST" onSuccesResponse={onSuccesForm} onErrorResponse={onErrorForm} loader={true}>

                <section>
                    <div className={stylesMainForm.sectionTitle}>
                        <h2>Funcionalidad</h2>
                        <div className={stylesMainForm.descriptionSection}>
                            <p> En este módulo podrá generar el reporte de etapa productiva de los Aprendices de formación titulada. Por lo tanto, deberá digitar los códigos de las fichas, separados por comas. <br /> <span>Ejemplo: 123456, 654321, 678901</span></p>
